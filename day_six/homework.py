...
def nearest_number(
    ...
    """
    Функция первым позиционным параметром берет массив (список либо set),
    ...
    затем возвращает самое близкое число исходя из массива (списка, set) sequence
    ...
    # элемента при итерации по массиву (списку, set)
